...
from cmdb import logic_Lei
from cmdb import logic_Ding
import traceback
import datetime
...
def update_info(request):
    ...
    if request.method == 'POST':
        ...
        logic_Lei.update_server_info.delay(srv)   # celery异步任务开始，传参srv，srv形如[u'1972', u'1973', u'1974', u'2014', u'2015', u'1993', u'1764', u'1977', u'1983', u'2012']的一个列表
        logic_Ding.update_server_info.delay(srv)   # celery异步任务开始，传参srv，srv形如[u'1972', u'1973', u'1974', u'2014', u'2015', u'1993', u'1764', u'1977', u'1983', u'2012']的一个列表
    return render(request, 'cmdb/cmdb.html', locals())
    ...
    try:
        ...
        if server_api_form.is_valid():
            ...
            if kw.split("-")[1] == "ali":
                ...
                logic_Lei.get_ali_servers.delay()
                logic_Ding.get_ali_servers.delay()
                get_ali_disk_info.delay()
                logic_Lei.get_ali_disk_info.delay()
                logic_Ding.get_ali_disk_info.delay()
            elif kw.split("-")[1] == "ksy":
                ...
                get_ali_servers()
                logic_Lei.get_ali_servers()
                logic_Ding.get_ali_servers()
                get_ali_disk_info()
                logic_Lei.get_ali_disk_info()
                logic_Ding.get_ali_disk_info()
                get_ksyun()
            res = {"result": True, "message": pubKeyContent}
            return JsonResponse(res)
        else:
